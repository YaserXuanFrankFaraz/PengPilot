...
const DESCRIPTION =
  'A fast, native app for local coding agents. Claude Code, Codex, Cursor, OpenCode, Grok, Kiro, Trae, DeepSeek, Hermes, Copilot, Kimi, Pi, and Oh My Pi — one timeline, entirely on your machine.'
