            ...
            TranscriptRowKind::Message(message_index) => self
                ...
                .map(|message| {
                    ...
                    let attachment_menus = (0..message.attachments.len())
                        ...
                        .collect();
                    // PengPilot keeps attachment files locally and has no
                    // daemon image channel; inline thumbnails stay as their
                    // file tiles, and the preview is reachable through the
                    // attachment menu.
                    let attachment_images = vec![None; message.attachments.len()];
                    let attachments_can_reveal = true;
