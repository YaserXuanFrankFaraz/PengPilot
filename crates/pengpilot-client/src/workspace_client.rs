use uuid::Uuid;
use pengpilot_protocol::{Command, ResponsePayload, WorkspaceOperation, WorkspaceResult};
...
impl WorkspaceClient {
    ...
    pub fn request(&self, operation: WorkspaceOperation) -> anyhow::Result<WorkspaceResult> {
            ...
            .request(Uuid::nil(), Uuid::nil(), Command::Workspace { operation })?
        {
            ...
            _ => anyhow::bail!("PengPilot daemon returned an invalid workspace response"),
        }
    }
}
